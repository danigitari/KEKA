  ...
  <div class="form  p-5">
    ...
    <div class="flex  flex-col justify-center lg:mx-20 lg:px-20">
      <div class="name flex flex-col gap-2 py-3">
        ...
        <input type="text" v-model="authenticFormData.name" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="company  flex flex-col gap-2 py-3">
        <label for=""> Company  <span class="text-red-500"> * </span> </label>
        <input type="text" v-model="authenticFormData.company" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="Phone  flex flex-col gap-2 py-3">
        <label for=""> Phone Number  <span class="text-red-500"> * </span> </label>
        <input type="text" v-model="authenticFormData.phonenumber" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="Email  flex flex-col gap-2 py-3">
        <label for=""> Email Address <span class="text-red-500"> * </span></label>
        <input type="text" v-model="authenticFormData.email" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
    ...
    <div class="flex  flex-col justify-center lg:mx-20 lg:px-20">
      <div class="name flex flex-col gap-2 py-3">
        <label for=""> Name <span class="text-red-500"> * </span> </label>
        <input type="text" v-model="daasCooperateFormData.name" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="company  flex flex-col gap-2 py-3">
        <label for=""> Company  <span class="text-red-500"> * </span> </label>
        <input type="text" v-model="daasCooperateFormData.company" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="Phone  flex flex-col gap-2 py-3">
        <label for=""> Phone Number  <span class="text-red-500"> * </span> </label>
        <input type="text" v-model="daasCooperateFormData.phone" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="Email  flex flex-col gap-2 py-3">
        <label for=""> Email Address <span class="text-red-500"> * </span></label>
        <input type="text" v-model="daasCooperateFormData.email" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
              <div class="Email  flex flex-col gap-2 py-3">
        <label for=""> Number of devices <span class="text-red-500"> * </span></label>
        <input type="text" v-model="daasSchoolsformData.number" class="form-control w-full py-2  px-2 text-green-darker rounded border-solid shadow-md">
      </div>
      <div class="self-end bg-kekaBlue text-white py-3 px-6 rounded-[25px] mb-10 ">
        Submit
      </div>
